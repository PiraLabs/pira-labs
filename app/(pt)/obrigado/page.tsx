...
export const metadata: Metadata = {
  ...
  description: 'Mensagem recebida pela PIRA LABS.',
      ...
      <div className="max-w-container mx-auto px-6 py-24">
        <div className="max-w-xl">
          ...
          <p className="font-body text-off-white/70 text-xl leading-relaxed mb-12">
            Recebemos seu contato. A PIRA LABS vai analisar sua mensagem e retornar pelo canal informado, caso exista aderência entre a sua demanda e o nosso trabalho.
          </p>
          <Link
            href="/"
