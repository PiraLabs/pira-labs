...
export const metadata: Metadata = {
  ...
  description: 'Mensaje recibido por PIRA LABS.',
      ...
      <div className="max-w-container mx-auto px-6 py-24">
        <div className="max-w-xl">
          ...
          <p className="font-body text-off-white/70 text-xl leading-relaxed mb-12">
            Recibimos tu mensaje. PIRA LABS va a revisar la solicitud y responder por el canal informado si existe encaje entre tu necesidad y nuestro trabajo.
          </p>
          <Link
            href="/es"
