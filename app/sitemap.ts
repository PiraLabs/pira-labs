...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/glossario`,                      changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/glossario/creative-business-turnaround`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/glossario/janela-de-oportunidade`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/glossario/antes-da-crise`,       changeFrequency: "monthly", priority: 0.7 },
